    ...
    while($statusmodalrow = mysqli_fetch_assoc($statusmodalresult)){
        ...
        elseif ($status == 5) 
            ...
            if ($status >= 1 && $status <= 4) {
                ...
                // Memeriksa apakah query berhasil dieksekusi dan apakah ada hasil yang dikembalikan
                if ($deliveryDetailResult && mysqli_num_rows($deliveryDetailResult) > 0) {
                    $deliveryDetailRow = mysqli_fetch_assoc($deliveryDetailResult);
                    // Memeriksa apakah $deliveryDetailRow tidak null sebelum mengakses elemen-elemennya
                    if ($deliveryDetailRow !== null) {
                        ...
                        // Handle jika $deliveryDetailRow null
                    }
                } else {
                    // Handle jika query tidak berhasil dieksekusi atau tidak ada hasil yang dikembalikan
                }
            } else {
                $trackId = '';
                $deliveryBoyName = '';
                        ...
                        <div class="card-body">
                            ...
                            <article class="card">
                                <div class="card-body row">
                                    <div class="col"> <strong>Estimated Delivery time:</strong> <br><?php echo isset($deliveryTime) ? $deliveryTime : ''; ?> </div>
                                    <div class="col"> <strong>Shipping By:</strong> <br> <?php echo isset($deliveryBoyName) ? $deliveryBoyName : ''; ?> | <i class="fa fa-phone"></i> <?php echo isset($deliveryBoyPhoneNo) ? $deliveryBoyPhoneNo : ''; ?> </div>
                                    <div class="col"> <strong>Status:</strong> <br> <?php echo isset($tstatus) ? $tstatus : ''; ?> </div>
                                    <div class="col"> <strong>Tracking #:</strong> <br> <?php echo isset($trackId) ? $trackId : ''; ?> </div>
                                </div>
                            </article>
                            <div class="track">
                            <?php
