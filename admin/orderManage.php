            ...
            <tbody>
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        $deliveryDate = $row['deliveryDate']; // Added delivery date
                        $deliveryTime = $row['deliveryTime']; // Added delivery time
                        ...
                        echo '<tr>
                                ...
                                <td>' . $paymentMode . '</td>
                                <td>' . $orderDate . '</td>
                                <td>' . $deliveryDate . '</td> <!-- Added delivery date -->
                                <td>' . $deliveryTime . '</td> <!-- Added delivery time -->
