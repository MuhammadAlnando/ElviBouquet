                ...
                <div class="card wish-list mb-3">
                    <div class="pt-4 border bg-light rounded p-3">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0 bg-light">Total Price<span id="totalPriceDisplay">Rp. <?php echo $totalPrice ?></span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-light">Shipping<span id="shippingCharge">+Rp. 15,000</span></li>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="deliveryOption" id="flexRadioDefault1" value="pickup" checked>
                            <label class="form-check-label" for="flexRadioDefault1">
                                Pickup
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="deliveryOption" id="flexRadioDefault2" value="delivery">
