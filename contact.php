...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-XueWvZ8f1bNsmFjOtRTvI26e3UTi2MOkNP0yHj8jTfMa3/5kDr9L8v4m5f9Ux7MlC9Bik5g2hTDhFaOzKOF8Vg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
      ...
      <div class="row justify-content-center contact-container">
        <div class="col-lg-8">
          <div class="card mb-4">
            <div class="row">
              <div class="col-lg-12">
                <div class="contact-box p-4 mx-auto">
                  <div class="row">
                    <div class="col-lg-8">
